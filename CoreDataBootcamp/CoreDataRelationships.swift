...
//  CoreDataBootcamp
//
//  Created by Frank Bara on 12/9/21.
//
...
//        request.predicate = filter
    ...
    func addBusiness() {
        ...
        newBusiness.name = "Sogeti"
        
        // add existing dept to new business
//                newBusiness.departments = [departments[0], departments[1]]
        
        // add existing employees to new business
//                newBusiness.employees = [employees[1]]
        
        // add new business to existing dept
...
//        newDepartment.addToEmployees(employees[1])
    ...
    func deleteBusiness() {
        let deleteBusiness = businesses[1]
        manager.context.delete(deleteBusiness)
        save()
    }
